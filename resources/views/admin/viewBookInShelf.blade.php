                                ...
                                @foreach($boooks as $book)
                                    <tr>
                                        ...
                                        <td>
                                                ...
                                                <button class="btn btn-warning btn-xs" style="width: 50px" data-toggle="modal" data-target="#editBookModal"
                                            ...
                                            <form action="{{action('bookController@destroy', $book['id'])}}" method="post">
                                                ...
                                                <button class="btn btn-danger btn-xs" style="width: 50px" type="submit">Delete</button>
                                            </form>
                                        </td>
